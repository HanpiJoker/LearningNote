/* 代码源自于Linux设备驱动开发详解(其实和Linux设备驱动的代码类似)
 * 主要学习的是字符设备驱动的开发框架, 通过框架来自己独立完成第一个
 * LED点灯实验;
 * 其中被注释掉的代码是用来创建多个设备的;
 */
...
static int __init globalmem_init (void)
{
	...
	globalmem_class_dev = class_device_create (globalmem_class, NULL, devno, NULL, "globalmem");
...
static void __exit globalmem_exit (void)
{
	...
	class_device_unregister (globalmem_class_dev);
