...
static int s3c2440_bus_xfer(struct i2c_adapter *adap, struct i2c_msg *msgs, int num)
{
	unsigned long timeout;

	// num个msg的I2C数据发送出去/读入
...
static u32 s3c2440_bus_func(struct i2c_adapter *adap)
{
...
static const struct i2c_algorithm s3c2440_bus_algo = {
	.master_xfer	= s3c2440_bus_xfer,
	.functionality	= s3c2440_bus_func,
};
...
static int __init i2c_bus_s3c_init(void)
{
...
static void __exit i2c_bus_s3c_exit(void)
{
...
module_init(i2c_bus_s3c_init);
module_exit(i2c_bus_s3c_exit);
MODULE_LICENSE("GPL");
